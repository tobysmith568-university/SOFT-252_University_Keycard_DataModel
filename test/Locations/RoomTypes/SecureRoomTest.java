 ...
 * @author Student
 */
public class SecureRoomTest {
    
    Floor testFloor = new Floor("1");
    Room room = RoomFactory.Create("01", RoomType.SECUREROOM);
    Keycard c1, c2, c3, c4, c5, c6, c7;
    
    public SecureRoomTest() {
    ...
    public void testAccessRequest() {
        ...
        assertEquals(false, TestAll(c2));
        assertEquals(false, TestAll(c3));
        assertEquals(false, TestAll(c4));
